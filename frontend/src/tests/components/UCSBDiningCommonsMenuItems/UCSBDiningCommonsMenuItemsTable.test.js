...
describe("UCSBDiningCommonsMenuItemsTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <UCSBDiningCommonsMenuItemsTable ucsbDiningCommonsMenuItems={ucsbDiningCommonsMenuItemsFixtures.threeDiningCommonsMenuItems} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
    );
  ...
  test("Edit button navigates to the edit page", async () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-diningCommonsCode`)).toHaveTextContent("carillo");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-name`)).toHaveTextContent("Pizza");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-station`)).toHaveTextContent("Pizza Station");
